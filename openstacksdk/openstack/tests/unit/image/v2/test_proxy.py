...
class TestObject(TestImageProxy):
    def test_metadef_object(self):
        self.verify_create(self.proxy.create_metadef_object, metadef_object.MetadefObject,
                           method_kwargs={"namespace": "test_id"},
                           expected_kwargs={"namespace": "test_id"})
